USE [DBAdmin]
GO
/****** Object:  StoredProcedure [dbo].[usp_Sizing]    Script Date: 15/10/2025 12:33:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER   PROCEDURE [dbo].[usp_Sizing] @Granularity VARCHAR(10) = NULL, @Database_Name sysname = NULL AS   
