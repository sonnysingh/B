USE [DBAdmin]
GO
/****** Object:  StoredProcedure [dbo].[IndexOptimize]    Script Date: 15/10/2025 12:31:57 PM ******/
SET ANSI_NULLS ON
GO
...
-- Changed fragmentation to go with Brent Ozar's recommendations:

@Databases nvarchar(max) = NULL,
@FragmentationLow nvarchar(max) = NULL,
@FragmentationMedium nvarchar(max) = 'INDEX_REORGANIZE,INDEX_REBUILD_ONLINE', -- Brent O removed INDEX_REBUILD_OFFLINE',
@FragmentationHigh nvarchar(max) = 'INDEX_REBUILD_ONLINE', -- Brent O removed INDEX_REBUILD_OFFLINE',
@FragmentationLevel1 int = 50,  -- Brent Ozar 50pct, original 5pct
@FragmentationLevel2 int = 80,  -- Brent Ozar 80pct, original 30pct
...
/****** Object:  Job [IndexOptimize - USER_DATABASES]    Script Date: 15/10/2025 12:36:55 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 15/10/2025 12:36:55 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [IndexOptimize - USER_DATABASES]    Script Date: 15/10/2025 12:36:56 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Index Optimize USER Sunday at 4:00', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_start_date=20241209, 
		@active_end_date=99991231, 
		@active_start_time=40000, 
		@active_end_time=235959, 
		@schedule_uid=N'6f3bfd0f-d6be-4741-9630-b240de18519f'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
